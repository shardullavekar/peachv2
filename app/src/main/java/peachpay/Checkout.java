...
public class Checkout {
    ...
    public void post(String url, String amount, String currency, String type, String recurring, String tokens, Callback callback) {
        ...
        checkoutAsynch.execute(new String[]{url, "checkout", tokens, amount, currency, type});
    }
    ...
    private class CheckoutAsynch extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                checkoutResponse = post.getId(params[0], params[1], params[2], params[3], params[4], params[5]);
            } catch (IOException e) {
                e.printStackTrace();
